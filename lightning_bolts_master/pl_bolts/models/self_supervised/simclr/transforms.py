...
class SimCLRTrainDataTransform:
    ...
    def __init__(
        self, input_height: int = 256, gaussian_blur: bool = True, jitter_strength: float = 1.0, normalize=None
    ) -> None:
        ...
        data_transforms = [
            transforms.RandomResizedCrop(size=self.input_height, scale=(0.2, 1.0)),
...
class SimCLREvalDataTransform(SimCLRTrainDataTransform):
    ...
    def __init__(
        ...
        self.online_transform = transforms.Compose(
            [
                transforms.Resize(int(self.input_height + 12)),
...
#class my_SimCLREvalDataTransform(SimCLRTrainDataTransform):
