...
from pl_bolts.models.self_supervised.swav.swav_resnet import resnet18, resnet50, resnet34
...
class SwAV(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--dataset", type=str, default="pathology", help="stl10, cifar10")
        ...
        parser.add_argument(
            "--size_crops", type=int, default=[160, 64], nargs="+", help="crops resolutions (example: [224, 96])"
        )
        parser.add_argument(
            "--min_scale_crops",
            type=float,
        ...
        parser.add_argument("--num_workers", default=20, type=int, help="num of workers per GPU")
        ...
        parser.add_argument("--nmb_prototypes", default=28, type=int, help="number of prototypes") #default is 512
        parser.add_argument(
            "--queue_length",
            type=int,
            default=0,
...
def cli_main():
    ...
    from lightning_bolts_master.pl_bolts.models.self_supervised.swav.pathology_datamodule import PathologyDataModule
    ...
    if args.dataset == "pathology":
        dm = PathologyDataModule(batch_size=args.batch_size, num_workers=args.num_workers)
    ...
    model_checkpoint = ModelCheckpoint(save_last=True, save_top_k=2, monitor="val_loss")
