...
class PathologyDataset(Dataset):
    ...
    #folder_list: list = "/home/skim/PycharmProjects/pythonProject/lightning-bolts-master/pl_bolts/models/self_supervised/moco/pathology_dataset_list.txt"
    ...
    def __init__(
        ...
        self.img_list = self.folder_list
    ...
    def _get_image(self, index: int):
        return Image.fromarray(np.transpose(self.data[index], (1, 2, 0)))
