...
import pl_bolts.models.self_supervised
import torch
...
feature_extracting = True #If True : model freezing, False : model Fine Tuning
...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers):
        ...
        #SELF_SUPERVISED MODEL PATH
        #SimCLR
        MODEL_PATH = "SimCLR_pretrained_weight.ckpt"
        #SwAV
        #MODEL_PATH = "SwAV_pretrained_weight.ckpt"
        if num_layers == 50:
