...
def pathology_normalization():
    if not _TORCHVISION_AVAILABLE:
        raise ModuleNotFoundError("You want to use `torchvision` which is not installed yet, install it with `pip install torchvision`.")


    normalize = transforms.Normalize(mean=[0.7116129, 0.5401812, 0.7484448],std=[0.10756037, 0.15484369, 0.12342755])
    return normalize
