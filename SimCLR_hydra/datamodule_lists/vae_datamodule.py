...
from datamodule_lists.cervix_dataset import CervixDataset
...
class VAEDataModule(LightningDataModule):
    ...
    def setup(self):
        ...
        self.test_dataset = CervixDataset(self.test_list, transform = self.test_transform())
...
if __name__ == "__main__":
    ...
    from datamodule_lists.vae_datamodule import VAEDataModule
